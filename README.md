...
Aplicación full-stack para registrar tareas, hábitos o estudio en una cuadrícula anual tipo GitHub contributions. 

El progreso se sincroniza entre dispositivos porque las tareas y marcas se guardan en Postgres mediante una API FastAPI.
...
No se usan cookies de analítica, publicidad ni terceros. Por eso la app muestra un aviso informativo, no un banner de consentimiento. 

Más detalle en [COOKIES.md](COOKIES.md).
